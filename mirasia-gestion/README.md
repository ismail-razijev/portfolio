...
│   ├── index.html / dashboard.js  # Dashboard (admin)
│   ├── plats.html / plats.js      # Gestion des plats & cuisines (admin, avec recherche/filtre)
│   ├── stock.html / stock.js      # Gestion du stock + historique des mouvements (admin)
│   ├── preparations.html / .js    # Planning de préparation (admin, avec filtres)
│   ├── ventes.html / ventes.js    # Enregistrement des ventes (admin)
│   ├── statistiques.html / .js    # Statistiques et mini-graphiques (admin)

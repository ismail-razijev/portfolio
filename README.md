À propos de moi
Je suis étudiant en 2e année de gestion des systèmes d'information et développement d'applications à l'IPEFA Sup Seraing-Verviers, où je me forme aux fondamentaux du développement logiciel : programmation C, bases de données (PL/pgSQL), administration Linux/Bash et développement web.
En parallèle de mes études, je travaille dans Mirasia, un restaurant à Verviers ouvert par mon frère et proposant une cuisine d'Asie centrale et du Caucase (ouïghoure, kazakhe, ouzbèke, tchétchène, russe, géorgienne) — j'ai participé à toute son ouverture. Cette double expérience m'a permis de développer des compétences concrètes en gestion de projet, création de sites web, et mise en place d'outils digitaux pour une petite entreprise — du site vitrine à la stratégie SEO, en passant par l'intégration d'outils de gestion.
...
Application de gestion pour le restaurant Mirasia : stock, planning de préparation, ventes (fonction PL/pgSQL transactionnelle FIFO), statistiques et dashboard analytique (ventes du jour, historique 10 jours, préparations, plats sous seuil), carte du restaurant, commande client, écran cuisine, interface salle avec plan personnalisable (tables déplaçables, durée d'occupation réelle) et réservations, comptes staff multi-rôles (admin/cuisine/salle), identité visuelle propre (maquettes conçues sur claude.ai/design) et tests automatisés.
...
🔗 [Démo en ligne — côté gestion (admin)](https://mirasia-gestion.onrender.com/login.html) — identifiants de démonstration disponibles sur demande
